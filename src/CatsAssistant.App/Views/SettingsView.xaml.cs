...
/// <summary>
/// Écran "Paramètres" (issues #24 et #23). <see cref="OnTokenPasswordChanged"/> est le seul point de contact entre
...
public partial class SettingsView : UserControl
{
    ...
    private void OnJiraPasswordFormClosed(object sender, RoutedEventArgs e) => JiraTokenPasswordBox.Clear();

    private void OnGitLabPasswordFormClosed(object sender, RoutedEventArgs e) => GitLabTokenPasswordBox.Clear();
