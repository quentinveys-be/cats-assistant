...
public class BusinessSqliteMigratorTests
{
    ...
    private static readonly string[] ExpectedTables = { "jira_tickets", "vcs_commits", "calendar_events" };
    ...
    public void Migrate_CreatesBusinessTablesOnly()
    {
        ...
        Assert.False(TableExists(connection, "time_blocks"));
        Assert.False(TableExists(connection, "rules"));
